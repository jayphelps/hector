...
Hector.Builders.templates["AttributeStatement"] = "Hector.Backbone.setAttribute\(\"\$key\"\,\ \$value\,\ \$contextName\)\;";
Hector.Builders.templates["AttributeDeclaration"] = "\$key:\ \$value";
Hector.Builders.templates["ViewStatement"] = "\<%\ if\ \(isConditional\)\ \{\ %\>\ if\ \(typeof\ \$constructorName\ \!==\ \"undefined\"\)\ \{\ var\ \$varName\ =\ new\ \$constructorName\(\)\;\ \$inner\ \$contextName.appendChild\(\$varName\)\;\ \}\ \<%\ \}\ else\ \{\ %\>\ var\ \$varName\ =\ \(typeof\ \$constructorName\ \!==\ \"undefined\"\)\ \?\ new\ \$constructorName\ :\ new\ Hector.options.elementConstructor\(\"\$constructorName\"\)\;\ \$inner\ \$contextName.appendChild\(\$varName\)\;\ \<%\ \}\ %\>";
Hector.Builders.templates["ViewDeclaration"] = "\<%=Hector.options.namespace%\>.\$constructorName\ =\ Hector.Backbone.View.extend\(\{\ \<%\ print\(attributes.join\(Hector.comma\)\)\;\ %\>\ \}\)\;";
